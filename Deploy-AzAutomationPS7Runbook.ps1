<#
    ...
    .DESCRIPTION
        ...
        Creates draft PowerShell 7.2 runbook.
...
function New-AzAutomationPS7ModuleDependency {
    ...
    Invoke-AzRestMethod -Method 'PUT' `
        ...
        -ResourceType 'automationAccounts' -Name "$AutomationAccountName/powershell7Modules/$ModuleName" -ApiVersion '2019-06-01&runtimeVersion=7.2' `
...
function New-AzAutomationPS7Runbook {
    ...
    Write-Output "Creating PowerShell 7.2 runbook ${RunbookName}"
    Invoke-AzRestMethod -Method 'PUT' `
        -ResourceGroupName $ResourceGroupName -ResourceProviderName 'Microsoft.Automation' `
    ...
    Invoke-AzRestMethod -Method 'PUT' `
        -ResourceGroupName $ResourceGroupName -ResourceProviderName 'Microsoft.Automation' `
        -ResourceType 'automationAccounts' -Name "$AutomationAccountName/runbooks/$RunbookName/draft/content" -ApiVersion 2022-06-30-preview `
